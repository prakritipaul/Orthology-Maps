...
```{r include=TRUE}
ciona_rds <- "/home/pprakriti/Desktop/vera_ciona_notoXnoto/notoXnoto_larva_DONE/notoXnoto_larva_seurat.rds"
...
# Are the matrices the same (Larva)?
# Yes! 

############################ IDENTIFY NOTOCHORD CELLS, EXPLORATION ##############################
