...
h5_matrix_dir <- paste0("~/Google Drive (ppaul@princeton.edu)/Levine Lab/Orthology Maps/h5_munging/4D_GSE131155_RAW/GSM3764764_", stage_name, "_raw_gene_bc_matrices_h5.h5")

h5_matrix_out_name <- paste0("~/Google Drive (ppaul@princeton.edu)/Levine Lab/Orthology Maps/h5_munging/h5_munging_output_files/", stage_name, "_out.txt")

h5_matrix_rownames_csv <- paste0("~/Google Drive (ppaul@princeton.edu)/Levine Lab/Orthology Maps/h5_munging/h5_munging_output_files/", stage_name, "_rownames.csv")

h5_matrix_colnames_csv <- paste0("~/Google Drive (ppaul@princeton.edu)/Levine Lab/Orthology Maps/h5_munging/h5_munging_output_files/", stage_name, "_colnames.csv")
