...
# SPECIFY #
```{r include=TRUE}
your.corR.mat <- mod.corR.mat
your.corR.pval.mat <- mod.corR.pval.mat
```
...
your.title <- "1-1 and 1-Many Larva CTs vs. Modified Zeb CTs"
...
# zeb.gsm/mod.zeb.gsm
num.CTs <- ncol(ciona.gsm)*ncol(mod.zeb.gsm)
