...
# 15
```{r include=TRUE}
larva_integrated_15 <- FindNeighbors(larva_integrated_15, dims = 1:15)
larva_integrated_15 <- FindClusters(larva_integrated_15, resolution = 1)
```
...
FeaturePlot(object = larva_integrated_15,
